                            ...
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 <td class="text-center">
                                     ...
                                     @else
                                     <td>
                                         <span class="badge badge-pill bg-danger text-white py-1 ml-5  px-3 inv-badge">Unpaid</span>
                                    </td>
                                     @endif
                                 <td >
                                     <div class="table-action">
                                         <a href="{{url('/patient/invoice_view',$data->id)}}" class="btn btn-sm bg-info-light">
