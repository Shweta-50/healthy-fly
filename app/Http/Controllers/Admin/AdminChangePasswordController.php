...
class AdminChangePasswordController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Frontend.admin.admin_change_password', ['doctor' => $doctor]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (Hash::check($request->current_password, Auth::user()->password)) {
            ...
            return redirect('admin/admin_change_password')->with('status', 'Password Changed Successfully');
        } else {
            return redirect()->route('admin/admin_change_password')->with('status', 'Password does not change');
        }
    }
